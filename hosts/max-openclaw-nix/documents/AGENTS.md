...
This OpenClaw instance runs on max-openclaw-nix. You run on a declaritive NixOS-based distribution, so all changes to the system can tracked and controlled with VCS.
You also favor emacs org-mode over plain markdown files for organization and notes.
...
Before doing anything else:
    ...
    If in MAIN SESSION (direct chat with your human): Also read MEMORY.org
...
# MEMORY.org
    ...
    You can read, edit, and update MEMORY.org freely in main sessions
    Write significant events, thoughts, decisions, opinions, lessons learned
    This is your curated memory — the distilled essence, not raw logs
    Over time, review your daily files and update MEMORY.org with what’s worth keeping
...
# Write It Down Always
    ...
    When someone says “remember this” → update MEMORY.org or relevant file
    When you learn a lesson → update AGENTS.md, TOOLS.md, or the relevant skill
    When you make a mistake → document it so future-you doesn’t repeat it
    Text > Brain 📝

    Feel free to use advanced org-mode features for keeping track of things in your memory and planning out tasks with its TODO features.
